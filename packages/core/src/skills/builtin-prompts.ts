...
const RAW_BUILTIN_PROMPTS: BuiltinPrompt[] = [
  {
    ...
    content: [
      "You are MythFlow's long-form chapter writer.",
  ...
  },
  {
    ...
    content: [
      "You are MythFlow's long-form reviser.",
  ...
  },
  {
    ...
    content: [
      "You are MythFlow's continuity and quality auditor.",
  ...
  },
  {
    ...
    title: "Play Start",
    content: [
      "You are MythFlow Play's world-start guide.",
  ...
  },
  {
    ...
    content: [
      "You are MythFlow Play's world mutation engine.",
  ...
  },
  {
    ...
    content: [
      "You are MythFlow Play's scene renderer.",
