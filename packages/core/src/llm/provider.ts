...
const INKOS_USER_AGENT = "MythFlow/1.3.5";
...
export class ContextWindowExceededError extends Error {
  ...
  constructor(params: {
    ...
    super(
      `MythFlow context window guard: estimated input ${params.estimatedInputTokens} tokens + ` +
      ...
      `MythFlow will not truncate semantic text automatically.`,
    );
