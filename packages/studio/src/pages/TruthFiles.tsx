          ...
          {selected && fileData?.content != null ? (
            <>
              {isLegacyShim && (
                ...
                >
                  <div className="font-medium">{isZh ? "兼容层只读 / Read-only compat shim" : "Read-only compat shim"}</div>
                  <div className="mt-1">
                    {t("truth.legacyBody")}
              ...
              {isRuntimeDiagnostic && (
                ...
                >
                  <div className="font-medium">{isZh ? "运行时诊断文件 / Runtime diagnostic" : "Runtime diagnostic"}</div>
                  <div className="mt-1">
                    {t("truth.diagBody")}
                  </div>
                </div>
