...
const ZH_CN: TuiCopy = {
  ...
  composer: {
    placeholder: "告诉 MythFlow 要写什么、修改什么，或解释什么…",
    emptyConversation: "先告诉 MythFlow 你要做什么。",
...
const EN: TuiCopy = {
  ...
  composer: {
    placeholder: "Ask MythFlow to write, revise, or explain…",
    emptyConversation: "Start by asking MythFlow what to do.",
